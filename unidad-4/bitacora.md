...
_Revisión y refinamiento del concepto original_
...
### Fases emocionales
1. **Exploración** → fase inicial, curiosa y flotante.  
2. **Tensión** → acumulación de energía, patrones que se comprimen.  
3. **Catarsis** → liberación expansiva, partículas en explosión.
...
- [x] **Servidor** con Node.js + Socket.IO.  
- [x] **Control remoto** (cambio de estados y parámetros).  
- [x] **Mobile1** (acelerómetro, giroscopio, touch).  
- [x] **Mobile2** (orientación, mag simulado, touch).  
- [x] **Webclient** (mouse, teclado, audio, video).  
- [x] **Desktop visual** integrando los 3 clientes + control.  
...
- [x] Especificación clara por estado (algoritmo + elementos + mapeo).  
- [x] Tablas de mapeo técnico detallado.  
- [x] Diseño de transiciones narrativas coherente.  
